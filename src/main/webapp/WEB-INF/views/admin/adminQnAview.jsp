		...
		<input type="hidden" name="q_no" value="${ adminQnA.q_no }">
			...
			<div class="ad_Detail">
				...
				<div>
					...
					<div id="qna_text">
						<textarea rows="50" cols="1000" style="width: 90%; height: 100px; border: none; resize: none;" name="an_content">${ adminQnA.an_content }</textarea>
						<button type="button" onclick="location.href='adminQnAlist.ad';">목록</button>
					</div>
				</div>
			</div>
		</form>
